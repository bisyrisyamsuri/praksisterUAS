                ...
                <div class="table-wrapper">
                    ...
                    <form action="add_data_mobil.php" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="plat" id="plat" class="form-control" required></input>
                        </div>
                        <div class="mb-3">
                            <label for="kapasitas" class="form-label">Kapasitas Mobil</label>
                            <input type="text" name="kapasitas" id="kapasitas" class="form-control" required></input>
                        </div>
                        <div class="mb-3">
